...
import 'package:app_materias/screens/auth/profile_screen.dart';
import 'package:app_materias/screens/startet.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    super.initState();
    getSharedPreferences(); // MANDAR A LLAMAR
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 20),
          child: SectionTitle(title: "Pagina Principal", press: () {}),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GestureDetector(
        onTap: () {
          if (product.title == "Perfil") {
            // 🔹 Cambio a comparación exacta
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ProfileScreen()),
            );
          } else if (product.title == "Materias") {
            // 🔹 Comparación exacta
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => MateriasScreen()),
            );
          } else if (product.title == "Materias Pendientes") {
            // 🔹 Comparación exacta
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => MateriasPendientesScreen(),
              ),
            );
          } else if (product.title == "Materias Aprobadas") {
            // 🔹 Comparación exacta
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => MateriasAprobadasScreen(),
              ),
            );
          }
        },
...
List<Product> demoProducts = [
  Product(
    ...
    title: "Perfil",
    price: 0.0,
    description: "Accede a tu perfil",
    colors: [
  ...
  Product(
    id: 2,
    images: ["assets/images/materias.jpg"],
    title: "Materias",
    price: 0.0,
    description: "Consulta todas las materias disponibles",
    colors: [
      const Color(0xFFF6625E),
      const Color(0xFF836DB8),
      const Color(0xFFDECB9C),
  ...
  Product(
    id: 3,
    images: ["assets/images/materiaspendientes.jpg"],
    title: "Materias Pendientes",
    price: 0.0,
    description: "Revisa las materias que aún debes aprobar",
    colors: [
      const Color(0xFFF6625E),
      const Color(0xFF836DB8),
      const Color(0xFFDECB9C),
  ...
  Product(
    id: 4,
    images: ["assets/images/materiasaprobadas.jpg"],
    title: "Materias Aprobadas",
    price: 0.0,
    description: "Consulta las materias que ya has aprobado",
    colors: [
      const Color(0xFFF6625E),
      const Color(0xFF836DB8),
      const Color(0xFFDECB9C),
